        ...
        <div className="container" style={{ padding: '72px 48px 96px' }}>
          <div style={{ maxWidth: 720, margin: '0 auto' }}>
            ...
            <div style={{ fontFamily: 'var(--font-serif)', fontSize: 18, fontWeight: 300, lineHeight: 1.8, color: 'var(--muted)', display: 'flex', flexDirection: 'column', gap: 24 }}>
              ...
              <p>Somos uma empresa curitibana especializada em poltronas, cadeiras e sofás. Cada peça do nosso catálogo é selecionada com cuidado — materiais testados, acabamento conferido, conforto que dura.</p>
              <p>Atendemos direto para quem vai sentar. Sem intermediários desnecessários, sem depósito no interior do estado. Isso significa preço justo, prazo real e alguém para responder quando você precisar.</p>
            ...
            <div style={{ marginTop: 56, display: 'flex', gap: 16, flexWrap: 'wrap' }}>
              <Link href="/como-fazemos" className="btn btn-dark">Como escolhemos <span className="btn-arrow">→</span></Link>
